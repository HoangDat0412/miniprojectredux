...
export default function DiemCuoc(props) {
    ...
    return (
        <div>
            <h3 className="text-center display-4 " style={{color:'#58FA58',marginTop:0}}>GAME BẦU CUA</h3>
            ...
            <div className="text-center mt-5">
                <button  style={{fontSize:'15px',borderRadius:'5%',border:'none'}} className="p-2 text-white bg-success" onClick={()=> dispatch({
                    type:'CHOI_LAI'
                })}> Chơi lại </button>
